...
class analyze_boston(dml.Algorithm):
    ...
    reads = []
    writes = ['kzhang21_ryuc_zui_sarms.landmarks', 'kzhang21_ryuc_zui_sarms.parks']
    ...
    def execute(trial=False):
        ...
        repo['kzhang21_ryuc_zui_sarms.landmarks'].insert_many(r)
        repo['kzhang21_ryuc_zui_sarms.landmarks'].metadata({'complete': True})
        print(repo['kzhang21_ryuc_zui_sarms.landmarks'].metadata())
        ...
        repo['kzhang21_ryuc_zui_sarms.parks'].insert_many(r)
        repo['kzhang21_ryuc_zui_sarms.parks'].metadata({'complete': True})
        print(repo['kzhang21_ryuc_zui_sarms.parks'].metadata())
    ...
    def provenance(doc=prov.model.ProvDocument(), startTime=None, endTime=None):
        ...
        this_script = doc.agent('alg:kzhang21_ryuc_zui_sarms#analyze_boston', {prov.model.PROV_TYPE: prov.model.PROV['SoftwareAgent'], 'ont:Extension': 'py'})
        ...
        parks = doc.entity('dat:kzhang21_ryuc_zui_sarms#parks', {prov.model.PROV_LABEL: 'Open Space', prov.model.PROV_TYPE: 'ont:DataSet'})
        ...
        landmarks = doc.entity('dat:kzhang21_ryuc_zui_sarms#landmarks', {prov.model.PROV_LABEL: 'Boston Landmarks', prov.model.PROV_TYPE: 'ont:DataSet'})
