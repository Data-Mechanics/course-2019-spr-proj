...
class entertainment(dml.Algorithm):
    ...
    reads = []
    writes = ['kzhang21_ryuc_zui_sarms.play']
    ...
    def execute(trial = False):
        ...
        repo['kzhang21_ryuc_zui_sarms.play'].insert_many(r)
        repo['kzhang21_ryuc_zui_sarms.play'].metadata({'complete':True})
        print(repo['kzhang21_ryuc_zui_sarms.play'].metadata())
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        this_script = doc.agent('alg:kzhang21_ryuc_zui_sarms#play', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        ...
        play = doc.entity('dat:kzhang21_ryuc_zui_sarms#play', {prov.model.PROV_LABEL:'Play Found', prov.model.PROV_TYPE:'ont:DataSet'})
