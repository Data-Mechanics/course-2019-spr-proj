...
SEARCH_LIMIT = 1
class trial_yelp_business(dml.Algorithm):
    contributor = 'kzhang21_ryuc_zui_sarms'
    reads = ['kzhang21_ryuc_zui_sarms.food_inspections_squished', 'kzhang21_ryuc_zui_sarms.trial_food_violations']
    writes = ['kzhang21_ryuc_zui_sarms.trial_yelp_business']
    ...
    def execute(trial = False):
        ...
        food_violations = repo['kzhang21_ryuc_zui_sarms.trial_food_violations']
        ...
        for index, row in df_inspections.iterrows():
            ...
            if result != [] and result is not None:
                ...
                if str(result["location"]["zip_code"]) in zip_codes:
                    ...
                    repo['kzhang21_ryuc_zui_sarms.trial_yelp_business'].insert_one(result)

        log.debug("Finishing %s", __name__)
        
        log.debug("Push data into mongoDB")
        # repo.dropCollection("trial_yelp_business")
        # repo.createCollection("trial_yelp_business")
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        this_script = doc.agent('alg:kzhang21_ryuc_zui_sarms#trial_yelp_business', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        ...
        yelp_business = doc.entity('dat:kzhang21_ryuc_zui_sarms#trial_yelp_business', {prov.model.PROV_LABEL:'Trial Yelp Businesses', prov.model.PROV_TYPE:'ont:DataSet'})
...
trial_yelp_business.execute()
doc = trial_yelp_business.provenance()
print(doc.get_provn())
