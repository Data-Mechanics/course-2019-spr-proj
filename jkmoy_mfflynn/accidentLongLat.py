...
class accidentLongLat(dml.Algorithm):
    ...
    def execute(trial = False):
        ...
        data = [(doc['lat'], doc['long']) for doc in collection]
        data2 = [(doc['lat'], doc['long']) for doc in collection2]
        ...
        final_dataset = [{'mean':tup[0], 'mean_points':tup[1], 'num_points':tup[2]} for tup in means]

        #print("final_dataset_accident: ", final_dataset[1])
