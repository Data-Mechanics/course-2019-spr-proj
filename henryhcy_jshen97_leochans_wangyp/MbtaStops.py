...
class MbtaStops(dml.Algorithm):
    ...
    reads = []
    writes = ['henryhcy_jshen97_leochans_wangyp.mbtaStops']
    ...
    def execute(trial=False):
        ...
        repo['henryhcy_jshen97_leochans_wangyp.mbtaStops'].insert_many(response_mbtaStops)
        repo['henryhcy_jshen97_leochans_wangyp.mbtaStops'].metadata({'complete': True})
        repo['henryhcy_jshen97_leochans_wangyp.mbtaStops'].delete_many({'status': 'INVALID_REQUEST'})

        print(repo['henryhcy_jshen97_leochans_wangyp.mbtaStops'].metadata())
    ...
    def provenance(doc=prov.model.ProvDocument(), start_time=None, end_time=None):
        ...
        this_script = doc.agent('alg:henryhcy_jshen97_leochans_wangyp#mbtaStops',
        ...
        mbtaStops = doc.entity('dat:henryhcy_jshen97_leochans_wangyp#mbtaStops',
