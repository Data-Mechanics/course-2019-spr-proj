...
class Transformation2(dml.Algorithm):
    ...
    reads = ['yufeng72.collegesUniversities','yufeng72.hubwayStations']
    ...
    def provenance(doc=prov.model.ProvDocument(), startTime=None, endTime=None):
        ...
        doc.wasDerivedFrom(collegesUniversities, stationNearbySchool, get_stationNearbySchool, get_stationNearbySchool,
                           get_stationNearbySchool)
        doc.wasDerivedFrom(hubwayStations, stationNearbySchool, get_stationNearbySchool, get_stationNearbySchool,
                           get_stationNearbySchool)
        repo.logout()
